...
class Component(BaseModel):
    ...
    def add_flavour_requirement(self, flavour:str, req_name, req_value, req_soft=False):
        if flavour not in self.flavours_requirements :
            self.flavours_requirements[flavour] = {}
        self.flavours_requirements[flavour][req_name] =  Requirement(name=req_name, value=req_value, soft=req_soft)
